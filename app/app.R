...
shinyApp(
         ui = navbarPage("Time-series isoform switch",
                         ...
                         tabPanel("Manual",
                                  ...
                                  br(),
                                  HTML('Example data are two csv files, data.exp.csv and mapping.csv: <a href="https://github.com/wyguo/TSIS" target="_blank">https://github.com/wyguo/TSIS</a>')
